...
apply dropout only ont last value"""
import os
import sys
...
conv_chan = 30                                         #number of kernel for convolution
...
with G.as_default():
    ...
    prediction = fully_connected(last,int(target.get_shape()[1]),activation_fn=tf.nn.elu,weights_regularizer=None,scope="prediction")
