...
num_step = 153                                        # time step before reduction
...
with tf.Session(graph=G) as sess:
    ...
    for epoch in range(num_epoch):
        ...
        if (time.clock()-tStart < trainDuration):
            ...
            print("Epoch {} MSE {:.5} on test set with deviation of {:.2}%".format(epoch,RMSETest,np.sqrt((RMSETrain-RMSETest)**2)/RMSETrain))
    ...
    input_binary = True
    output_node_names = "FCLayer/prediction:0"
